window.addEventListener('load', function(){
            ...
            <div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1" uk-slider="clsActivated: uk-transition-active; center: true">
                ...
                <ul class="uk-slider-items uk-grid">
                    <li class="uk-width-3-4">
                        <div class="uk-panel">
                        <a href='detail.html?id=${element.id}&title=${element.title}&img=${element.poster_path}&gnrid=${element.genre_ids}&resumen=${element.overview}&media_type=movie'> <img src="https://image.tmdb.org/t/p/w500${element.poster_path}" alt=""> </a>
    ...
    .then(function(information) {
        ...
        for (let index = 0; index < 8; index++) {
            ...
            <li class="uk-width-3-4">
            <div class="uk-panel">
            <a href='detail.html?id=${element.id}&title=${element.name}&img=${element.poster_path}&gnrid=${element.genre_ids}&resumen=${element.overview}&media_type=tv'> <img src="https://image.tmdb.org/t/p/w500${element.poster_path}" alt=""> </a>
            <div class="uk-overlay uk-overlay-primary uk-position-bottom uk-text-center uk-transition-slide-bottom">
